...
// //               <li key={comment._id} className="border p-4 rounded shadow-sm bg-gray-50">
// //                 <p className="text-gray-800">{comment.text}</p>
// //                 <div className="mt-2 text-sm text-gray-500">
// //                   Sample Ref:{" "}
// //                   <span className="font-medium">{comment.Sample?.SampleRef || "N/A"}</span>
// //                   {" | "}
// //                   Due Date:{" "}
...
//         <button
//           onClick={() => navigate("/")}
//           className="px-3 py-2 bg-gray-500 text-white rounded hover:bg-gray-700 text-sm"
//         >
//           ← Back to Samples
//         </button>
//       </div>
